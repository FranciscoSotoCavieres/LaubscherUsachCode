...
# def write_vector3_vertex_file(filePath: str, vertices: list[Vec3]):
#     file = open(filePath, 'w', newline='')
#     writer = csv.writer(file)
...
# def get_mesh(vec3s:list[Vec3]) -> TriangleMesh:
...
#     list_of_list_vec3: list[Vec3] = []

#     for line in lines:
#         list_of_vec3: list[Vec3] = []
